...
def get_context_keyboard(language="ru"):
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="💼 В продажах и переговорах", callback_data="context:sales")],
        [InlineKeyboardButton(text="👥 В управлении людьми", callback_data="context:management")],
        [InlineKeyboardButton(text="🤝 В командной работе", callback_data="context:team")],
        [InlineKeyboardButton(text="💬 В коммуникации", callback_data="context:communication")],
        [InlineKeyboardButton(text="⚠️ В стрессе", callback_data="context:stress")],
        [InlineKeyboardButton(text="🚀 Совет по развитию", callback_data="context:advice")],
    ])
